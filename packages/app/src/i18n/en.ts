...
export const dict = {
  ...
  "command.programmingMode.toggle": "Toggle Programming Mode",
  ...
  "provider.custom.models.sync": "Sync models",
  "provider.custom.models.syncError": "Failed to fetch models",
  ...
  "session.git.tab": "Git",
  "session.git.currentBranch": "Current branch",
  "session.git.switchBranch": "Switch branch",
  "session.git.newBranch": "New branch",
  "session.git.branchName": "Branch name",
  "session.git.createBranch": "Create",
  "session.git.commitMessage": "Commit message",
  "session.git.commit": "Commit",
  "session.git.push": "Push",
  "session.git.committed": "Changes committed",
  "session.git.pushed": "Changes pushed",
  "session.git.commitFailed": "Commit failed",
  "session.git.pushFailed": "Push failed",
  "session.git.checkoutFailed": "Branch switch failed",
  "session.git.noBranches": "No branches found",
  "session.git.newBranchOption": "New branch...",
  "session.git.createFrom": "Create from",
  "session.git.stage": "Stage",
  "session.git.unstage": "Unstage",
  ...
  "session.ide.files": "Files",
  "session.ide.git": "Git",
  "session.ide.search": "Search",
  "session.ide.search.placeholder": "Search files",
  "session.ide.search.empty": "No results",
  "session.ide.search.noQuery": "Type a query to search",
  "session.ide.search.results": "Results",
  "session.ide.chat": "Chat",
  "session.ide.chat.collapse": "Collapse chat",
  "session.ide.chat.expand": "Expand chat",

  "fileEditor.edit": "Edit",
  "fileEditor.revert": "Revert",
  "fileEditor.saved": "File saved",
  ...
  "settings.general.row.programmingMode.title": "Programming Mode",
  "settings.general.row.programmingMode.description":
    "Open the Git panel by default in the right sidebar instead of the Files Changed view.",
  ...
  "settings.agents.saved.title": "Saved",
  "settings.agents.saved.description": "Restart OpenCode to apply changes.",
  "settings.agents.empty": "No agent config files found.",
  "settings.agents.reload": "Reload",
  "settings.agents.kind.mode": "Mode",
  "settings.agents.unsaved.title": "Unsaved changes",
  "settings.agents.unsaved.description": "You have unsaved changes to this agent. Switching will discard them.",
  "settings.agents.unsaved.discard": "Discard",
